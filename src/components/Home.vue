        ...
        <div class="row">
            ...
            >
                ...
                <a
                    ...
                    @click="togglePlay($event, track)"
                    :style="[
                        track.id === currentTrack.id || isLinkedFrom(track.id)
                            ? { display: 'block !important' }
                            : {},
                    ]"
                >
...
export default {
    ...
    beforeMount() {
        axios
            .get(`${props.api}/me/player/recently-played?limit=9`, {
                headers: {
                    Authorization:
                        `Bearer ${
        ...
        axios
            .get(`${props.api}/me/top/tracks?limit=9`, {
                headers: {
                    Authorization:
                        `Bearer ${
                            JSON.parse(window.localStorage.getItem('spotify'))
        ...
        axios
            .get(`${props.api}/browse/new-releases?limit=9`, {
                headers: {
                    Authorization:
                        `Bearer ${
                            JSON.parse(window.localStorage.getItem('spotify'))
